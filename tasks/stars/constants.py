...
REPORTS_STARS_IMAGE_PATH = f"{REPORTS_STARS_CATEGORY}{REPORTS_NAME_SEPARATOR}{REPORTS_IMAGE_SUFFIX}"
REPORTS_STARS_MAP_PATH = f"{REPORTS_STARS_CATEGORY}{REPORTS_NAME_SEPARATOR}{REPORTS_MAP_SUFFIX}"
REPORTS_REGION_MAP_PATH = f"{REPORTS_REGION_CATEGORY}{REPORTS_NAME_SEPARATOR}{REPORTS_MAP_SUFFIX}"
REPORTS_STARS_HEATMAP_PATH = f"{REPORTS_STARS_CATEGORY}{REPORTS_NAME_SEPARATOR}{REPORTS_HEATMAP_SUFFIX}"
REPORTS_MAGNITUDE_PLOT_PATH = f"{REPORTS_MAGNITUDE_CATEGORY}{REPORTS_NAME_SEPARATOR}{REPORTS_PLOT_SUFFIX}"
